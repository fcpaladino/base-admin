...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            ...
            basePath: function () {
                ...
                b = b.replace('admin/', 'js/plugins/ckeditor/');
                return b
            }(),
            getUrl: function (a) {
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function (a, b, c, i) {
                ...
                showBlock: function (a, b, c, i, f, h) {
                    ...
                    var d = this.element, a = this._.iframe, a = CKEDITOR.env.ie && !CKEDITOR.env.edge ? a : new CKEDITOR.dom.window(a.$.contentWindow), g = d.getDocument(), o = this._.parentElement.getPositionedAncestor(), p = b.getDocumentPosition(g), g = o ? o.getDocumentPosition(g) : {
                        x: 0,
                        y: 0
                    }, m = "rtl" == this._.dir, e = p.x +
                        (i || 0) - g.x, k = p.y + (f || 0) - g.y;
                    ...
                    this._.blurSet || (CKEDITOR.event.useCapture = !0, a.on("blur", function (a) {
                        ...
                        (this.visible && !this._.activeChild) && (CKEDITOR.env.iOS ? this._.hideTimeout || (this._.hideTimeout = CKEDITOR.tools.setTimeout(q, 0, this)) : q.call(this))
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            c = a.top;
                            b.height - a.top < f && (k = c > f ? k - f : b.height >
                            f ? k - a.bottom + b.height : k - a.top);
                            if (CKEDITOR.env.ie) {
                    ...
                    }, this), this._.activeChild = a, this._.focused = !1, a.showBlock(b, c, g, f, h), this.blur(), (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) &&
                    setTimeout(function () {
            ...
            $: function (a, b) {
                ...
                add: function (a) {
                    ...
                    if (!i) {
                        ...
                        i.onShow = function () {
                            i._.panel.getHolderElement().getParent().addClass("cke").addClass("cke_reset_all")
                        };
        ...
        requires: "dialog,fakeobjects", onLoad: function () {
            ...
            a.on("doubleclick", function (d) {
                ...
                if (!a.blockless && c.is("form"))d.data.dialog = "form"; else if (c.is("select"))d.data.dialog = "select"; else if (c.is("textarea"))d.data.dialog =
                    "textarea"; else if (c.is("img") && c.data("cke-real-element-type") == "hiddenfield")d.data.dialog = "hiddenfield"; else if (c.is("input")) {
        ...
        function f(b, c, a) {
            if (!b.getCustomData("indent_processed")) {
                ...
                if (c) {
                    ...
                    var c = k(b, a), a = parseInt(b.getStyle(c), 10), g = d.config.indentOffset || 40;
                    isNaN(a) && (a = 0);
                    a += (j ? 1 : -1) * g;
                    if (0 > a)return;
                    a = Math.max(a,
                            ...
                            refresh: function (a, b) {
                                ...
                                if (d) {
                                    var c = d, e = e.$.className.match(this.classNameRegex),
                                        f = this.isIndent, c = e ? f ? e[1] != c.slice(-1) : true : f;
                                    return c ? l : i
                                }
                                ...
                                if (c = a.elementPath().contains(m))f.call(this, c, d); else {
                                    b = b.createIterator();
                                    a = a.config.enterMode;
                                    b.enforceRealBlocks = true;
                                    for (b.enlargeBr = a != CKEDITOR.ENTER_BR; c = b.getNextParagraph(a == CKEDITOR.ENTER_P ? "p" : "div");)c.isReadOnly() || f.call(this, c, d)
                                }
                                return true
                            }
                        }
    ...
    (function () {
        function s(c) {
            ...
            for (var j = this, n = this.database, m = this.context, l = c.getSelection(), l = (l && l.getRanges()).createIterator(), d; d = l.getNextRange();) {
                ...
                m) && (h = new CKEDITOR.dom.walker(d), h.evaluator = p, d.endContainer = h.previous());
                if (b)return f(b)
            }
            return 0
        }
    ...
    (function () {
        ...
        var p = /^javascript:/, q = /^mailto:([^?]+)(?:\?(.+))?$/, r = /subject=([^;?:@&=$,\/]*)/,
            s = /body=([^;?:@&=$,\/]*)/, t = /^#(.*)$/, u = /^((?:http|https|ftp|news):\/\/)?(.*)$/, v = /^(_(?:self|top|parent|blank))$/, w = /^javascript:void\(location\.href='mailto:'\+String\.fromCharCode\(([^)]+)\)(?:\+'(.*)')?\)$/, x = /^javascript:([^(]+)\(([^)]+)\)$/, y = /\s*window.open\(\s*this\.href\s*,\s*(?:'([^']*)'|null)\s*,\s*'([^']*)'\s*\)\s*;\s*return\s*false;*\s*/, z = /(?:^|,)([^=]+)=(\d+|yes|no)/gi, k = {
                id: "advId",
                dir: "advLangDir",
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (c) {
                ...
                if (b) {
                    ...
                    var a = {}, h;
                    for (h in k)(e = b.getAttribute(h)) && (a[k[h]] = e);
                ...
                if (b.advanced) {
                    for (var j in k)(a = b.advanced[k[j]]) && (f[j] = a);
                    f.name && (f["data-cke-saved-name"] = f.name)
                }
                f["data-cke-saved-href"] && (f.href = f["data-cke-saved-href"]);
                j = {target: 1, onclick: 1, "data-cke-pa-onclick": 1, "data-cke-saved-name": 1};
                b.advanced && CKEDITOR.tools.extend(j, k);
                for (var l in f)delete j[l];
                return {set: f, removed: CKEDITOR.tools.objectKeys(j)}
            }
        };
    ...
    (function () {
        function E(b, k, e) {
            function c(c) {
                if ((a = d[c ? "getFirst" : "getLast"]()) && (!a.is || !a.isBlockBoundary()) && (m = k.root[c ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(!0))) && (!m.is || !m.isBlockBoundary({br: 1})))b.document.createElement("br")[c ? "insertBefore" : "insertAfter"](a)
            }
            ...
            var d = CKEDITOR.plugins.list.arrayToList(f, e, null, b.config.enterMode, k.root.getAttribute("dir")).listNode, a, m;
            c(!0);
            c();
            d.replace(k.root);
        ...
        function A(b, k, e, c) {
            for (var f, g; f = b[c ? "getLast" : "getFirst"](F);)(g = f.getDirection(1)) !== k.getDirection(1) && f.setAttribute("dir", g), f.remove(), e ? f[c ? "insertBefore" : "insertAfter"](e) : k.append(f, c)
        }
        ...
        function y(b, k, e) {
            ...
            k.trim(!1, !0);
            var f = k.createBookmark(), g = new CKEDITOR.dom.elementPath(k.startContainer), i = g.block, g = g.lastElement.getAscendant("li", 1) || i, h = new CKEDITOR.dom.elementPath(e.startContainer), d = h.contains(CKEDITOR.dtd.$listItem), h = h.contains(CKEDITOR.dtd.$list);
            ...
            listToArray: function (b,
                ...
                for (var g = 0, i = b.getChildCount(); g < i; g++) {
                    ...
                    if ("li" == h.$.nodeName.toLowerCase()) {
                        ...
                        e.push(d);
                        for (var a = 0, m = h.getChildCount(), j; a < m; a++)j = h.getChild(a), j.type == CKEDITOR.NODE_ELEMENT && r[j.getName()] ? CKEDITOR.plugins.list.listToArray(j, k, e, c + 1, d.grandparent) : d.contents.push(j)
                    }
                }
                return e
                ...
                for (var g, i = b[e].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(i), d = null, a = e, m = Math.max(b[e].indent, 0), j = null, n, l, p = c == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                    ...
                    if (o.indent == m) {
                        ...
                        a++
                    } else if (o.indent == Math.max(m, 0) + 1)o = b[a - 1].element.getDirection(1), a = CKEDITOR.plugins.list.arrayToList(b, null, a, c, o != n ? n : null), !j.getChildCount() && (CKEDITOR.env.needsNbspFiller && 7 >= i.$.documentMode) && j.append(i.createText(" ")),
                        ...
                        var d = g.getDirection(1) != n, u = o.element, z = u.getAttribute("class"), v = u.getAttribute("style"), w = j.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (c != CKEDITOR.ENTER_BR || d || v || z), s, x = o.contents.length, t;
                ...
                if (k)for (b = h.getFirst(); b;) {
                    if (b.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(k, b), b.getName()in
                        CKEDITOR.dtd.$listItem && (e = b, i = f = c = void 0, c = e.getDirection()))) {
        ...
        x.prototype = {
            exec: function (b) {
                ...
                var k = b.config, e = b.getSelection(), c = e && e.getRanges();
                ...
                for (var k = e.createBookmarks(!0), f = [], i = {}, c = c.createIterator(), h = 0; (g = c.getNextRange()) && ++h;) {
                    var d = g.getBoundaryNodes(), a = d.startNode, m = d.endNode;
                    a.type == CKEDITOR.NODE_ELEMENT && "td" == a.getName() && g.setStartAt(d.startNode, CKEDITOR.POSITION_AFTER_START);
                    m.type == CKEDITOR.NODE_ELEMENT &&
                    "td" == m.getName() && g.setEndAt(d.endNode, CKEDITOR.POSITION_BEFORE_END);
                    g = g.createIterator();
                    for (g.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; d = g.getNextParagraph();)if (!d.getCustomData("list_block")) {
                        ...
                        for (var j = b.elementPath(d), a = j.elements, m = 0, j = j.blockLimit, n, l = a.length - 1; 0 <= l && (n = a[l]); l--)if (r[n.getName()] && j.contains(n)) {
                ...
                for (n = []; 0 < f.length;)if (a = f.shift(), this.state == CKEDITOR.TRISTATE_OFF)if (r[a.root.getName()]) {
                    ...
                    j = [];
                    for (d = 0; d < h.contents.length; d++)if (l = h.contents[d], (l = l.getAscendant("li",
                    ...
                    for (var l = h.root.getDocument(), p = void 0, o = void 0, d = 0; d < j.length; d++) {
                        var u = j[d].getCustomData("listarray_index"), p = m[u].parent;
                    ...
                    for (d = 0; d < j && (m = a.listNode.getChild(d)); d++)m.getName() ==
                    this.type && g.push(m);
                    ...
                    for (l = 0; l < j.length; l++)d = d.getCommonAncestor(j[l].getParent());
                    ...
                    if (!(1 > h.length)) {
                        ...
                        g.push(l);
                        for (p = g = void 0; h.length;)g = h.shift(), p = c.createElement("li"), g.is("pre") || H.test(g.getName()) || "false" == g.getAttribute("contenteditable") ? g.appendTo(p) : (g.copyAttributes(p), a && g.getDirection() && (p.removeStyle("direction"), p.removeAttribute("dir")), g.moveChildren(p), g.remove()), p.appendTo(l);
                ...
                var e = k.contains(r, 1), c = k.blockLimit || k.root;
        ...
        CKEDITOR.plugins.add("list", {
            requires: "indentlist", init: function (b) {
                b.blockless || (b.addCommand("numberedlist", new x("numberedlist", "ol")), b.addCommand("bulletedlist",
                    ...
                    var e = k.data.domEvent.getKey(), c;
                        ...
                        if (f && f.collapsed) {
                            ...
                            if (i) {
                                ...
                                if ((a = g.contains(r)) && f.checkBoundaryOfElement(a, CKEDITOR.START) && (a = a.getParent()) && a.is("li") && (a = w(a))) {
                                    ...
                                    if ((a = d.previous()) && a.type == CKEDITOR.NODE_ELEMENT && (a.getName()in
                                        r || a.is("li"))) {
                                        if (!a.is("li")) {
    ...
    (function () {
        function Q(a, c, d) {
            return l(c) && l(d) && d.equals(c.getNext(function (a) {
                    return !(z(a) || A(a) || p(a))
                }))
        }
        ...
        function J(a) {
            var c = a.element;
            if (c && l(c) && (c = c.getAscendant(a.triggers, !0)) && a.editable.contains(c)) {
                var d = K(c);
        ...
        function r(a, c, d) {
            return c =
                c[d ? "getPrevious" : "getNext"](function (b) {
                    return b && b.type == CKEDITOR.NODE_TEXT && !z(b) || l(b) && !p(b) && !v(a, b)
                })
        }
        ...
        function ga(a) {
            ...
            q(d, {
                ...
                lineChildren: [q(B('<span title="' + a.editor.lang.magicline.title + '" contenteditable="false">&#8629;</span>', c), {
                    base: L + "height:17px;width:17px;" + (a.rtl ? "left" : "right") + ":17px;background:url(" + b + ") center no-repeat " + a.boxColor + ";cursor:pointer;" + (o.hc ? "font-size: 15px;line-height:14px;border:1px solid #fff;text-align:center;" : "") + (o.hidpi ? "background-size: 9px 10px;" : ""),
                    looks: ["top:-8px; border-radius: 2px;",
                ...
                place: function () {
                    var b = a.view, c = a.editable, d = a.trigger, h = d.upper, g = d.lower, j = h || g, m = j.getParent(), k = {};
                    this.trigger = d;
                    h && n(a, h, !0);
                    g && n(a, g, !0);
                    n(a, m, !0);
                    a.inInlineMode && C(a, !0);
                    m.equals(c) ? (k.left = b.scroll.x, k.right = -b.scroll.x, k.width = "") : (k.left = j.size.left - j.size.margin.left + b.scroll.x - (a.inInlineMode ? b.editable.left + b.editable.border.left :
                            0), k.width = j.size.outerWidth + j.size.margin.left + j.size.margin.right + b.scroll.x, k.right = "");
                    ...
                    d.is(x) || k.top > b.scroll.y - 15 && k.top < b.scroll.y + 5 ? (k.top = a.inInlineMode ? 0 : b.scroll.y, this.look(x)) : d.is(y) || k.top >
                    b.pane.bottom - 5 && k.top < b.pane.bottom + 15 ? (k.top = a.inInlineMode ? b.editable.height + b.editable.padding.top + b.editable.padding.bottom : b.pane.bottom - 1, this.look(y)) : (a.inInlineMode && (k.top -= b.editable.top + b.editable.border.top), this.look(s));
            ...
            d.lineChildren[0].on("mouseup", function (b) {
                ...
                a.editor.focus();
                !o.ie && a.enterMode != CKEDITOR.ENTER_BR && a.hotNode.scrollIntoView();
        ...
        function N(a, c, d) {
            ...
            o.ie && a.enterMode == CKEDITOR.ENTER_BR ? f = a.doc.createText(E) : (f = (f = K(a.element, !0)) && f.data("cke-enter-mode") || a.enterMode, f = new M(F[f], a.doc), f.is("br") || a.doc.createText(E).appendTo(f));
        ...
        function T(a, c) {
            return {
                canUndo: !0, modes: {wysiwyg: 1}, exec: function () {
                    function d(b) {
                        var d =
                            o.ie && 9 > o.version ? " " : E, f = a.hotNode && a.hotNode.getText() == d && a.element.equals(a.hotNode) && a.lastCmdDirection === !!c;
                        N(a, function (d) {
                    ...
                    return function (b) {
                        var b = b.getSelection().getStartElement(), e, b = b.getAscendant(U, 1);
                        if (!V(a, b) && b && !b.equals(a.editable) && !b.contains(a.editable)) {
                            if ((e = K(b)) && "false" == e.getAttribute("contenteditable"))b = e;
                            a.element = b;
                            e = r(a, b, !c);
                            var f;
                            l(e) && e.is(a.triggers) && e.is(ha) && (!r(a, e, !c) || (f = r(a, e, !c)) && l(f) && f.is(a.triggers)) ? d(e) : (f = J(a, b), l(f) && (r(a, f, !c) ? (b = r(a, f, !c)) && (l(b) && b.is(a.triggers)) && d(f) : d(f)))
                        }
                    }
                }()
            }
        ...
        function G(a, c) {
            return l(c) ? c.is(a.triggers) : null
        }
        ...
        function X(a) {
            ...
            if (!l(c) || p(c) || !G(a, c))return null;
            n(a, c);
            return !f && 0 <= c.size.top && 0 <
        ...
        function Z(a) {
            ...
            if (p(e) || ia(a, e, h) || e.getParent().is($))return null;
            var g = r(a, e, !h);
            if (g) {
                if (g && g.type == CKEDITOR.NODE_TEXT)return null;
                if (l(g)) {
                    if (p(g) || !G(a, g) || g.getParent().is($))return null;
                    f = [g, e][h ? "reverse" : "concat"]().concat([O, H])
                }
            } else e.equals(a.editable[h ? "getLast" : "getFirst"](a.isRelevant)) ? (C(a), h && c.y > e.size.bottom - b && c.y < d.pane.height && e.size.bottom > d.pane.height - b && e.size.bottom < d.pane.height ? i = y : 0 < c.y && c.y < e.size.top + b && (i = x)) : i = s, f = [null, e][h ? "reverse" : "concat"]().concat([h ? Y : D, H, i, e.equals(a.editable[h ?
                "getLast" : "getFirst"](a.isRelevant)) ? h ? y : x : s]);
            return 0 in f ? new u(f) : null
        }

        function P(a, c, d, b) {
            for (var e = c.getDocumentPosition(), f = {}, i = {}, h = {}, g = {}, j = t.length; j--;)f[t[j]] = parseInt(c.getComputedStyle.call(c, "border-" + t[j] + "-width"), 10) || 0, h[t[j]] = parseInt(c.getComputedStyle.call(c, "padding-" + t[j]), 10) || 0, i[t[j]] = parseInt(c.getComputedStyle.call(c, "margin-" + t[j]), 10) || 0;
            (!d || b) && I(a, b);
            ...
            return q({border: f, padding: h, margin: i, ignoreScroll: d}, g, !0)
        }

        function n(a, c, d) {
            if (!l(c))return c.size = null;
            if (c.size) {
                if (c.size.ignoreScroll == d && c.size.date > new Date - aa)return null
            } else c.size = {};
        ...
        function ka(a, c, d, b) {
            for (var e = b, f = b, i = 0, h = !1, g = !1, j = a.view.pane.height, m = a.mouse; m.y + i < j && 0 < m.y - i;) {
                h || (h = c(e, b));
                g || (g = c(f, b));
                !h && 0 < m.y - i && (e = d(a, {x: m.x, y: m.y - i}));
                !g && m.y + i < j && (f = d(a, {x: m.x, y: m.y + i}));
                if (h && g)break;
                i += 2
            }
        ...
        CKEDITOR.plugins.add("magicline", {
            init: function (a) {
                ...
                a.on("contentDom", function () {
                    ...
                    d.is(w.$inline) || (b.inInlineMode && !W(d) && d.setStyles({
                        position: "relative",
                        top: null,
                        left: null
                    }), ga.call(this, b), I(b), d.attachListener(a, "beforeUndoImage", function () {
                        b.line.detach()
                    }), d.attachListener(a,
                        ...
                        if (!("wysiwyg" != a.mode || a.readOnly || i)) {
                            ...
                            i = setTimeout(function () {
                                ...
                                i = b.trigger = null;
                                I(b);
                                if (f && !b.hiddenMode && a.focusManager.hasFocus && !b.line.mouseNear() && (b.element = ba(b, !0)))(b.trigger =
                        ...
                        "wysiwyg" == a.mode && (b.line.detach(), o.webkit && (b.hiddenMode = 1, clearTimeout(e), e = setTimeout(function () {
                            b.mouseDown || (b.hiddenMode = 0)
                        }, 50)))
                    }), d.attachListener(da ? g : j, "mousedown", function () {
                        "wysiwyg" == a.mode && (b.line.detach(), b.hiddenMode = 1, b.mouseDown = 1)
                    }), d.attachListener(da ? g : j, "mouseup", function () {
                        b.hiddenMode = 0;
                        b.mouseDown = 0
                    }), a.addCommand("accessPreviousSpace",
                        T(b)), a.addCommand("accessNextSpace", T(b, !0)), a.setKeystroke([[c.magicline_keystrokePrevious, "accessPreviousSpace"], [c.magicline_keystrokeNext, "accessNextSpace"]]), a.on("loadSnapshot", function () {
                        var c, d, e, f;
                        ...
                        accessFocusSpace: N, boxTrigger: u, isLine: v, getAscendantTrigger: J, getNonEmptyNeighbour: r,
        ...
        var ba = function () {
            ...
            return function (c, d, b) {
                ...
                var e = c.doc, f = c.line.wrap, b = b || c.mouse, i = a(e, b);
                d && v(c, i) && (f.hide(), i = a(e, b), f.show());
            ...
            function a(a) {
                ...
                if (!l(b) || b.contains(a.editable) || b.isReadOnly())return null;
                i = ka(a, function (a, b) {
                    return !b.equals(a)
                }, function (a, b) {
                    return ba(a, !0, b)
                ...
                for (var b = Number.MAX_VALUE, h, g, j, m; f && !f.equals(e) && (g = e.getNext(a.isRelevant));)h = Math.abs(fa(a, e, g) - a.mouse.y), h < b && (b = h, j = e, m = g), e = g, n(a, e);
                if (!j || !m || !(a.mouse.y > j.size.top && a.mouse.y < m.size.bottom))return null;
                i.upper = j;
                i.lower = m;
                return i.set(O, ea)
            }
        ...
        CKEDITOR.plugins.add("maximize", {
            init: function (a) {
                ...
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    var f = a.lang, b = CKEDITOR.document, c = b.getWindow(), j, k, m, l = CKEDITOR.TRISTATE_OFF;
                    a.addCommand("maximize", {
                        ...
                        exec: function () {
                            ...
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                ...
                                for (d = a.container; d = d.getParent();)d.setCustomData("maximize_saved_styles", o(d)), d.setStyle("z-index", a.config.baseFloatZIndex - 5);
                                g.setCustomData("maximize_saved_styles", o(g, !0));
                                h.setCustomData("maximize_saved_styles", o(h, !0));
                                ...
                                for (var d = [g, h], n = 0; n < d.length; n++)q(d[n], d[n].getCustomData("maximize_saved_styles")), d[n].removeCustomData("maximize_saved_styles");
                                for (d = a.container; d = d.getParent();)q(d, d.getCustomData("maximize_saved_styles")), d.removeCustomData("maximize_saved_styles");
                                CKEDITOR.env.ie ? setTimeout(function () {
                                    c.$.scrollTo(m.x, m.y)
                                }, 0) : c.$.scrollTo(m.x,
                                    m.y);
                            ...
                            if (d = this.uiItems[0])g = this.state == CKEDITOR.TRISTATE_OFF ? f.maximize.maximize : f.maximize.minimize, d = CKEDITOR.document.getById(d._.id), d.getChild(1).setHtml(g), d.setAttribute("title", g), d.setAttribute("href", 'javascript:void("' +
                                g + '");');
                            "wysiwyg" == a.mode ? j ? (CKEDITOR.env.gecko && r(a), a.getSelection().selectRanges(j), (i = a.getSelection().getStartElement()) && i.scrollIntoView(!0)) : c.$.scrollTo(k.x, k.y) : (j && (i.selectionStart = j[0], i.selectionEnd = j[1]), i.scrollLeft = k[0], i.scrollTop = k[1]);
                            j = k = null;
                            l = this.state;
        ...
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", init: function (a) {
            ...
            a.contextMenu && a.addMenuItems && (a.contextMenu.addListener(function () {
                ...
                if (d) {
                    var f =
                        d.getSelectionNode();
                    if (f = f ? f.getAttribute(d.getNodeAttribute()) : f)b = c.menuGenerator(a, f, c), d.showBanner("." + a.contextMenu._.definition.panel.className.split(" ").join(" ."))
                }
                return b
            ...
            var d = CKEDITOR.plugins.scayt, b = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE, f = function () {
                ...
                d.attachListener(d, "focus", function () {
                    ...
                    var d = CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state[a.name] && a.scayt,
                        c, f;
                    if ((b || d) && a._.savedSelection)for (var d = a._.savedSelection.getSelectedElement(), d = !d && a._.savedSelection.getRanges(), i = 0; i < d.length; i++)f = d[i], "string" === typeof f.startContainer.$.nodeValue && (c = f.startContainer.getText().length, (c < f.startOffset || c < f.endOffset) && a.unlockSelection(!1))
                }, this, null, -10)
            }, h = function () {
            ...
            a.on("beforeCommandExec", function (b) {
                var c;
                if (b.data.name in d.options.disablingCommandExec &&
                    "wysiwyg" == a.mode) {
            ...
            a.on("paste", function () {
                var d = a.scayt;
                d && d.removeMarkupInSelectionNode()
            }, null, null, 0)
            ...
            if (a.config.scayt_disableOptionsStorage) {
                ...
                a.config.scayt_disableOptionsStorage = function (a) {
                    for (var d = [], b = 0; b < a.length; b++) {
                        var c = a[b], j = !!g(a, "options");
                        if (!g(f, c) || j && g(e, function (a) {
                                if (a === "lang")return false
                            }))return;
                        g(e, c) && e.splice(h(e, c), 1);
                        if (c === "all" || j && g(a, "lang"))return [];
                        c === "options" && (e = ["lang"])
                    }
                    return d = d.concat(e)
                }(c)
            ...
            var c = a.dataProcessor, d = c && c.htmlFilter, b = a._.elementsPath && a._.elementsPath.filters, c = c && c.dataFilter, f = a.addRemoveFormatFilter, e = function (d) {
            ...
            if (0 < c.length && "no_any_suggestions" !== c[0])for (var e = 0; e < c.length; e++) {
                ...
                a.addCommand(g, this.createCommand(CKEDITOR.plugins.scayt.suggestions[e]));
                e < a.config.scayt_maxSuggestions ? (a.addMenuItem(g, {
                    ...
                    order: e + 1
                }), b[g] = CKEDITOR.TRISTATE_OFF, "on" === a.config.scayt_moreSuggestions &&
            ...
            var d = a.scayt, b = this.scaytMenuDefinition(a),
                f = {}, e = a.config.scayt_contextCommands.split("|");
            ...
            for (var g in b)-1 == CKEDITOR.tools.indexOf(e, g.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (f[g] = CKEDITOR.TRISTATE_OFF, "function" === typeof b[g].verification && !b[g].verification(a) && delete f[g], a.addCommand(g, {exec: b[g].exec}), a.addMenuItem(g, {
                label: a.lang.scayt[b[g].label] ||
    ...
    CKEDITOR.plugins.scayt = {
        ...
        createScayt: function (a) {
            ...
            this.loadScaytLibrary(a, function (a) {
                ...
                b.subscribe("selectionIsChanged", function () {
        ...
        loadScaytLibrary: function (a, c) {
            var d = this, b;
            "undefined" === typeof window.SCAYT || "function" !== typeof window.SCAYT.CKSCAYT ? this.loadingHelper[a.name] || (this.loadingHelper[a.name] = c, this.loadingHelper.loadOrder.push(a.name), b = new Date, b = b.getTime(), b = a.config.scayt_srcUrl + "?" + b, CKEDITOR.scriptLoader.load(b, function () {
                var a;
    ...
    CKEDITOR.on("scaytReady", function () {
        if (!0 === CKEDITOR.config.scayt_handleCheckDirty) {
            ...
            a.checkDirty = CKEDITOR.tools.override(a.checkDirty, function (a) {
                return function () {
                    ...
                    if (!CKEDITOR.plugins.scayt || !CKEDITOR.plugins.scayt.state[this.name] || !this.scayt)b = a.call(this); else if (b = "ready" == this.status)var e = c.removeMarkupFromString(this.getSnapshot()), c = c.removeMarkupFromString(this._.previousValue), b = b && c !== e;
                    return b
                }
            });
        ...
        if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
            ...
            a[c] = CKEDITOR.tools.override(a[c], function (a) {
                return function (b) {
                    var c = b.editor.scayt, e = this.contents, g = b.contents, h = null;
                    CKEDITOR.plugins.scayt &&
                    ...
                    tablecell: {
                        label: c.cell.menu, group: "tablecell", order: 1, getItems: function () {
                            ...
                            return {
                                ...
                                tablecell_split_horizontal: w(a, !0) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
    ...
    (function () {
        var setIcons = function (icons, strip) {
            var path = CKEDITOR.getUrl('../js/plugins/' + strip);
            icons = icons.split(',');
